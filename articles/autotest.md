...
#> ✔ Creating /tmp/Rtmpg1hs7J/demo/.
#> ✔ Setting active project to "/tmp/Rtmpg1hs7J/demo".
#> ✔ Creating R/.
#> ✔ Writing DESCRIPTION.
#> Package: demo
...
[`as.integer()`](https://rdrr.io/r/base/integer.html). The following
suffices to remove that message.
